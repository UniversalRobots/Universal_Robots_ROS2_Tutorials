...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("full_husky_control"), "urdf", "full_husky_controlled.urdf.xacro"]),
            " ",
            "robot_ip:=",
            robot_ip,
            " ",
    ...
    initial_joint_controllers = PathJoinSubstitution(
        [FindPackageShare("full_husky_control"), "config", "ros2_controllers.yaml"]
    )
    ...
    static_state_publisher_node = Node(
        package="full_husky_control",  # Replace with your package name
        executable="static_state_publisher",
    ...
    nodes_to_start.append(static_state_publisher_node)
